...
TypeScript requires a configuration file to specify compiler options. In your project's root directory, create a `tsconfig.json` file and copy-paste this full code.
